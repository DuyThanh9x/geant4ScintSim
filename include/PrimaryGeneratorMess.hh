...
#ifndef PrimaryGeneratorMess_h
#define PrimaryGeneratorMess_h 1
...
class PrimaryGeneratorMess : public G4UImessenger
{
  public:
    PrimaryGeneratorMess (PrimaryGeneratorAction*);
    ~PrimaryGeneratorMess() override;
