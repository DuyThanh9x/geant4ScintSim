...
EventActionMess :: EventActionMess (EventAction* eventaction)
  : fEventAction(eventaction)
{
  fSetVerboseCmd = new G4UIcmdWithAnInteger("/scinsm/eventVerbose", this);
...
EventActionMess :: ~EventActionMess()
{
...
void EventActionMess :: SetNewValue(G4UIcommand* command, G4String newValue)
{
